...
public class JDialogFonts extends JDialog
{
	...
	public static Font selectedFont = Common.font_input;
	...
	public JDialogFonts(JDialog parent, Font target)
	{
		...
		btnCancel.setIcon(Common.icon_cancel);
		...
		fontNamesList.setModel(fontNamesModel);
		fontNamesList.setCellRenderer(Common.renderer_fontlist);
		...
		fontStylesList.setModel(fontStylesModel);
		fontStylesList.setCellRenderer(Common.renderer_list);
		...
		fontSizeList.setModel(fontSizeModel);
		fontSizeList.setCellRenderer(Common.renderer_list);
