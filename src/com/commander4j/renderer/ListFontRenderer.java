...
/**
 */
public class ListFontRenderer extends JLabel implements ListCellRenderer<Object>
{
	...
	public ListFontRenderer(Color newBackgroundColor)
	{
		separator = new JSeparator(JSeparator.HORIZONTAL);
	...
	{
		{
			...
			renderer.setFont(new Font(((String) value),0,12));
